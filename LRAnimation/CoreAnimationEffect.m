...
//    rotationAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
    ...
    CABasicAnimation *scaleAnimation = [CABasicAnimation animationWithKeyPath:@"backgroundColor"];
    scaleAnimation.fromValue = (__bridge id)view.backgroundColor.CGColor;
    scaleAnimation.toValue = (__bridge id)[UIColor yellowColor].CGColor;
    ...
    [view.layer addAnimation:scaleAnimation forKey:@"backgroundColor"];
...
//    anim1.duration = 3.0f;
//    anim1.fromValue = (__bridge id)view.backgroundColor.CGColor;
//    anim1.toValue = (__bridge id)[UIColor yellowColor].CGColor;
...
+ (void)animationFlipFromTop:(UIView *)view
{
    ...
    [view.layer addAnimation:animation forKey:@"oglFlipfromTop"];
}
